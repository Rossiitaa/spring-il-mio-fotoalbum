...
public class SecurityConfiguration {
	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests()
				...
				.requestMatchers("/photos", "/photos/**").hasAnyAuthority(allRoles).requestMatchers("/**").permitAll()
				.and().formLogin().and().logout().and().exceptionHandling().accessDeniedPage("/access-denied.html");
